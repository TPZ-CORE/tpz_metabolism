...
Config = {
    ...
    MinTemperatureDrainThirst  = 2.0,  -- Set to 0 if you don't want to drain thirst when player's temperature reaches the selected value.

    MaxTemperature       = 40, -- If the player temperature is that high, it will start draining more water and hunger. (40°C As default)
    MaxTemperatureDrainThirst  = 2.0,  -- Set to 0 if you don't want to drain thirst when player's temperature reaches the selected value.
